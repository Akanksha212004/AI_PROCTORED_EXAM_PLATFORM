...
//       <Card className="p-5">
//         <SubmissionsTable submissions={items} isLoading={isLoading} showExaminer onReview={handleReview} />
//         <Pagination pagination={pagination} onPageChange={setPage} itemLabel="submissions" />
//       </Card>
...
function SubmissionsContent() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="font-display text-2xl font-semibold text-paper">{t("admin.submissions.title")}</h1>
      ...
      <Card className="p-5">
        <SubmissionsTable submissions={items} isLoading={isLoading} showExaminer onReview={handleReview} />
        <Pagination pagination={pagination} onPageChange={setPage} itemLabelKey="common.itemLabels.submissions" />
      </Card>
