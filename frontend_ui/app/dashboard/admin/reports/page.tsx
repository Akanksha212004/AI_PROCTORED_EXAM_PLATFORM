...
//             </span>
//             <p className="text-sm text-muted">No exams have been created on the platform yet.</p>
//           </div>
//         ) : (
...
//                   <th className="px-5 py-3 font-medium">Examiner</th>
...
//                     </td>
//                     <td className="px-5 py-3.5 text-paper/80">{exam.examinerName ?? "—"}</td>
//                     <td className="px-5 py-3.5">
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1.5 text-sm text-paper/60">{t("admin.reports.subtitle")}</p>
      </div>
            ...
            <table className="w-full min-w-[940px] text-left text-sm">
              <thead>
                <tr className="border-b border-border text-xs uppercase tracking-wide text-muted">
                  ...
                  <th className="px-5 py-3 font-medium">{t("admin.reports.table.examiner")}</th>
                    ...
                    <td className="px-5 py-3.5">
                      <div className="flex justify-end gap-2">
                        ...
                        {/* <button
                          ...
                          disabled={downloadingId === `${exam.id}-csv` || exam.attempts === 0}
                          className="inline-flex items-center gap-1.5 rounded-lg border border-border px-3 py-1.5 text-xs text-paper/70 transition-colors hover:bg-white/5 disabled:cursor-not-allowed disabled:opacity-40"
                          title={exam.attempts === 0 ? t("admin.reports.noSubmissionsYetTitle") : "Download CSV"}
                        >
                          <Download className="h-3.5 w-3.5" />
                          {downloadingId === `${exam.id}-csv` ? "…" : "CSV"}
                        </button> */}
