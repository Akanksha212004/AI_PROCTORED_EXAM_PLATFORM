...
function AdminUsersContent() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="font-display text-2xl font-semibold text-paper">{t("admin.users.title")}</h1>
      ...
      <Card className="overflow-hidden p-0">
        <UserTable
          ...
          onChangeRole={setRoleTarget}
        />
        <Pagination pagination={pagination} onPageChange={setPage} itemLabelKey="common.itemLabels.accounts" />
      </Card>
