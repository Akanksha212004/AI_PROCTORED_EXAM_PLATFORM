...
function StudentDetailContent() {
  ...
  const { student, isLoading, notFound, refetch } = useStudentDetail(params.studentId);
      ...
      <div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <Button
            ...
            className={cn(
              "h-8 w-auto px-3 py-1.5 text-xs",
              student.isActive ? "border-accent-rose/30 text-accent-rose" : "border-accent-teal/30 text-accent-teal"
            )}
          >
