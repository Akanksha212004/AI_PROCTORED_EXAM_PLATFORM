...
export function QuestionPanel({
  ...
  const [selectedIds, setSelectedIds] = useState<Set<string>>(() =>
    new Set(question.answer?.selectedOptionIds ?? [])
  );

  useEffect(() => {
    setSelectedIds(new Set(question.answer?.selectedOptionIds ?? []));
  }, [question.questionId, question.answer?.selectedOptionIds]);
  ...
  function toggleMultiSelect(optionId: string) {
    ...
    setSelectedIds((prev) => {
      ...
      onSelectOptions(Array.from(next));
      return next;
    });
  }
