...
export const submitAnswerSchema = z.object({
  ...
  selectedOptionIds: z.array(z.string().min(1)).optional(),
  submittedText: z.string().trim().optional(),
  markedForReview: z.boolean().optional(),   // NEW — persists review flag independent of answer content
  clearAnswer: z.boolean().optional(),        // NEW — when true, wipes options/text/fileUrl for this question
});
